									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<form:select class="form-control" path="truckType">
												...
												<form:options items="${ truckTypeDDL }" itemValue="lookupCode" itemLabel="lookupDescription"/>
											</form:select>															
										</div>										
									</div>
									<div class="form-group">
										...
										<div class="col-sm-3">
											<form:select class="form-control" path="weightType">
												...
												<form:options items="${ weightTypeDDL }" itemValue="lookupCode" itemLabel="lookupDescription"/>
											</form:select>															
										</div>										
									</div>
									<div class="form-group">
