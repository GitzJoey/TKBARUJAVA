									...
									<table class="table table-bordered table-hover">
										...
										<tbody>
											<c:if test="${not empty poList}">
												<c:forEach items="${ poList }" var="i" varStatus="status">
													<tr>
														...
														<td>
															<c:out
																value="${ i.poCode }"></c:out>
														</td>
														<td>
															<c:out
																value="${ i.poCreatedDate }"></c:out>
														</td>
														<td>
															<c:out
																value="${ i.supplierLookup.supplierName }"></c:out>
														</td>
													</tr>
												</c:forEach>
											</c:if>
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-5">
																				<form:input type="text" class="form-control"
																					id="inputPOCode" name="inputPOCode"
																					path="poForm.poCode" placeholder="Enter PO Code"></form:input>
																			</div>
																		</div>
																		<div class="form-group">
																				...
																				<c:forEach items="${ poForm.itemsList }" var="iL"
																					...
																					<tr>
																						<td style="vertical-align: middle;"><form:hidden
																								path="itemsList[${ iLIdx.index }].itemsId" /> <c:out
																								value="${poForm.itemsList[iLIdx.index].productLookup.productName }"></c:out>
																						</td>
																					...
																					<c:set var="qty" value="${ itemsList[ iLIdx.index ].prodQuantity }"></c:set>
																					<c:set var="price" value="${ itemsList[ iLIdx.index ].prodPrice }"></c:set>
